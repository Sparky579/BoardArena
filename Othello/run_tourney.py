"""Round-robin tournament for Othello baseline bots.
...
from env.othello_env import OthelloEnv, load_bot, DEFAULT_MAX_PLIES
...
def play_one_game(bot_black, bot_white, seed: int, decision_timeout: float, max_plies: int):
    env = OthelloEnv(seed=seed, max_plies=max_plies)
...
def main():
    parser = argparse.ArgumentParser(description="Othello baseline bot round-robin tournament")
