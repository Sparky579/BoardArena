...
DEFAULT_BOT = HERE.parent / "baseline" / "gpt5p5" / "bot.py"
STATIC_TYPES = {
...
class ChessServer(ThreadingHTTPServer):
    def __init__(self, server_address: tuple[str, int], *, bot_path: Path, seed: int | None, max_plies: int) -> None:
