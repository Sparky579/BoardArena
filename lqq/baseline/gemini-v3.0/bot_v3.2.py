"""Gemini V3.2 (Killer Heuristic + Pessimistic Race).

Features:
- Alpha-Beta with Killer Moves and History Heuristic for crazy fast move ordering.
- "Pessimistic Race" evaluation offset to naturally avoid 50-50 traps and prioritize defense.
- Zero Object Allocation in search.
"""
...
class Bot:
    ...
    def _generate_moves(self, my_pos, opp_pos, my_path, opp_path, my_wrem, h_mask, v_mask, h_walls, v_walls, ply):
        ...
        # Move Ordering: Killer > Own Path Pawn > Other Pawn > Walls (History)
    ...
    def _alpha_beta(self, my_pos, opp_pos, my_goal, opp_goal, my_wrem, opp_wrem, h_mask, v_mask, h_walls, v_walls, depth, ply, alpha, beta):
        ...
        if depth == 0:
            ...
            # Pessimistic Offset: artificially reduce our advantage to favor traps
