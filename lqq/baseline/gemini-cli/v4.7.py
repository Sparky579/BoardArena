"""Gemini V4.7 - The Balanced Hunter.

Key features:
- Restricted BFS wall scoring (only at root and near-root).
- Light heuristic for deep node wall ordering.
- Immediate win check.
- High-performance bitboard BFS.
    ...
    def search(self, p0, p1, w0, w1, hw, vw, hm, vm, turn, depth, ply, alpha, beta):
        ...
        if my_w > 0:
            ...
            for d, r, c in cands:
                ...
                # Expensive scoring only near root
                if depth >= 5:
                    i9 = r * 9 + c
        ...
        for i, (sc, a) in enumerate(scored):
            ...
            if a < 8:
                ...
                if get_dist(n_my, my_g, n_hm, n_vm) >= 255: continue
