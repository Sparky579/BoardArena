"""Gemini V4.15 - The Pure Evolver.

Key features:
- Simple Alpha-Beta (matches V3 complexity).
- Persistent TT with Zobrist Hashing.
- Exact match of V3 evaluation and move generation.
"""
...
class Engine:
    ...
    def search(self, p0, p1, w0, w1, hw, vw, hm, vm, turn, depth, ply, alpha, beta):
        ...
        for i, (sc, a) in enumerate(moves):
            ...
            v_sc = -self.search(n_p0, n_p1, n_w0, n_w1, nhw, nvw, nhm, nvm, 1-turn, depth-1, ply+1, -beta, -alpha)
    ...
    def choose(self, state):
        ...
        try:
            for depth in range(1, 40):
                score = self.search(p0, p1, w0, w1, hw, vw, hm, vm, me, depth, 0, -WIN_SCORE*4, WIN_SCORE*4)
