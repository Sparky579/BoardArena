"""Round-robin tournament for Uno baseline bots.
...
from env.uno_env import UnoEnv, load_bot, DEFAULT_MAX_PLIES
...
def play_one_game(bot_0, bot_1, seed: int, decision_timeout: float, max_plies: int):
    env = UnoEnv(seed=seed, max_plies=max_plies)
    bots = [bot_0, bot_1]
...
def main():
    parser = argparse.ArgumentParser(description="Uno baseline bot round-robin tournament")
