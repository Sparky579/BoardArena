"""Round-robin tournament for Go 9x9 baseline bots.
...
from env.go_env import Go9x9Env, load_bot, DEFAULT_MAX_PLIES
...
def play_one_game(bot_black, bot_white, seed: int, decision_timeout: float, max_plies: int):
    env = Go9x9Env(seed=seed, max_plies=max_plies)
...
def main():
    parser = argparse.ArgumentParser(description="Go 9x9 baseline bot round-robin tournament")
